...
draw_generation_v_main_region_menu = ImageDraw.Draw(buffer_generation_v_main_region_menu)
...
draw_generation_vi_main_region_menu = ImageDraw.Draw(buffer_generation_vi_main_region_menu)
...
draw_generation_vii_main_region_menu = ImageDraw.Draw(buffer_generation_vii_main_region_menu)
...
draw_generation_viii_main_region_menu = ImageDraw.Draw(buffer_generation_viii_main_region_menu)
...
def update_display_generation_v_main_region_menu(selected_index):
    ...
    for i in range(max_visible_items):
        if start_index_generation_v_main_region_menu + i < total_generation_v_main_region_menu_items:
            region_name = main_region_data[start_index_generation_v_main_region_menu + i].get("name", "")
...
def update_display_generation_vi_main_region_menu(selected_index):
    ...
    for i in range(max_visible_items):
        if start_index_generation_vi_main_region_menu + i < total_generation_vi_main_region_menu_items:
            region_name = main_region_data[start_index_generation_vi_main_region_menu + i].get("name", "")
...
def update_display_generation_vii_main_region_menu(selected_index):
    ...
    for i in range(max_visible_items):
        if start_index_generation_vii_main_region_menu + i < total_generation_vii_main_region_menu_items:
            region_name = main_region_data[start_index_generation_vii_main_region_menu + i].get("name", "")
...
def update_display_generation_viii_main_region_menu(selected_index):
    ...
    for i in range(max_visible_items):
        if start_index_generation_viii_main_region_menu + i < total_generation_viii_main_region_menu_items:
            region_name = main_region_data[start_index_generation_viii_main_region_menu + i].get("name", "")
...
def update_display_generation_ix_main_region_menu(selected_index):
    ...
    for i in range(max_visible_items):
        if start_index_generation_ix_main_region_menu + i < total_generation_ix_main_region_menu_items:
            region_name = main_region_data[start_index_generation_ix_main_region_menu + i].get("name", "")
